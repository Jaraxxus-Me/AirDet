...
def main(shot):
    ...
    for dataType in ['train2017']: #, 'train2017']:
        ...
        annFile = os.path.join(root_path, 'new_annotations/final_split_voc_{}_shot_instances_train2017.json'.format(shot))
...
def get_args():
    parser = argparse.ArgumentParser(description='Adjust support')
...
if __name__ == '__main__':
    since = time.time()
    args = get_args()
    support_df = main(args.shot)
    support_df.to_pickle("./{}_shot_support_df.pkl".format(args.shot))
